...
def setup_db(db_name):
	...
	c.execute("CREATE TABLE alignments (alignment_id integer primary key autoincrement, read_id text, chrom text, pos integer, strand integer, n_hits integer, p_method text, prob integer, foreign key(read_id) references reads(read_id))")
